...
public class PearlAltaiMainPage {
    ...
    public void waitForPearlAltaiMainPageHeaderAndMiddlePartLoaded() {
        returnToMainPageButton.shouldBe(Condition.hidden, Duration.ofSeconds(7));
        firstProductSection.shouldBe(Condition.visible, Duration.ofSeconds(7));
    }
    ...
    public void waitForPearlAltaiMainPageFooterLoaded() {
        siteDeveloperLogoLink.shouldBe(Condition.visible, Duration.ofSeconds(7));
    }
    ...
    public void waitForNavigationElementsLoaded() {
        searchField.shouldBe(Condition.hidden, Duration.ofSeconds(7));
        mainMenu.shouldBe(Condition.visible, Duration.ofSeconds(7));
    }
    ...
    public void openCatalogue() {
        Selenide.executeJavaScript("document.querySelector('img[src=\"/data/files/138.png\"]').scrollIntoView();");
        Selenide.executeJavaScript("document.querySelector('img[src=\"/data/files/138.png\"]').click();");
        catalogueButton.shouldBe(Condition.visible, Duration.ofSeconds(7));
